...
export default function Section1() {
  return (
    <div>
      <div className="bg-amber-900 h-15 flex justify-center items-center">
        <span className="text-white font-bold">Welcome to our Bakery</span>
      </div>
      <nav className=" dark:bg-gray-900 fixed w-full z-20  border-b border-gray-200 dark:border-gray-600 ">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <span className="flex gap-0 items-center">
            <Image src={logo} alt="My Image" width={120} height={30} />
